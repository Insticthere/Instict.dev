    ...
    <div className="px-2 pb-6">
      ...
      <div className="pt-1 grid sm:grid-cols-2 gap-y-2.5 gap-x-2  grid-cols-1">
        { data.projects.map((element, key) => (
          <a
          className="rounded-lg bg-[#1b1b1bd5] dark:bg-[#edededb3] shadow-md backdrop-blur-sm p-3 sm:p-3.5 flex justify-between border-[#9e9d9d21] dark:border-[#b5b3b3] border-solid border-t-[2px] hover:-translate-y-0.5 transition-transform"
          href={element.link}
          key={key} 
